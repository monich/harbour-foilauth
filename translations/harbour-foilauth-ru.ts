...
<context>
    ...
    <message id="foilauth-foil_password-label-enter_password_short">
        ...
        <translation>Коды авторизации заблокированы</translation>
    </message>
    <message id="foilauth-foil_password-label-enter_password_long">
        ...
        <translation>Коды авторизации заблокированы. Введите пароль</translation>
    </message>
    ...
    <message id="foilauth-token-label-placeholder">
        ...
        <translation>Описание кода авторизации</translation>
    </message>
    ...
    <message id="foilauth-token-digits-placeholder">
        ...
        <translation>Количество цифр в пароле</translation>
    </message>
    <message id="foilauth-token-timeshift-text">
        <source>Time shift (seconds)</source>
        <extracomment>Text field label (number of password digits)</extracomment>
        <translation>Временной сдвиг (секунды)</translation>
    </message>
    ...
    <message id="foilauth-password_list-placeholder">
        ...
        <translation>Здесь пусто, совсем ничего нет</translation>
    </message>
    ...
    <message id="foilauth-generate_key_warning-text">
        ...
        <translation>Если вы затрёте старый ключ новым, то скорее всего навсегда потеряете доступ к файлам, зашифрованным старым ключём, включая файлы, зашифрованные &quot;дружественными&quot; приложениями вроде Foil Notes или Foil Pics. Если вы забыли пароль и надеетесь когда-нибудь потом расшифровать файлы, то имейте в виду, что, как правило, подобрать пароль и восстановить старый ключ значительно проще, чем расшифровать файлы, не имея ключа.</translation>
    </message>
    ...
    <message id="foilauth-confirm_password-description">
        ...
        <translation>Если вы забудете пароль, то восстановить его будет невозможно и таким образом доступ к зашифрованным кодам будет утерян. Так что лучше отнеситесь к этому серьёзно.</translation>
    </message>
    ...
    <message id="foilauth-add_token-title">
        ...
        <translation>Новый код авторизации</translation>
    </message>
    <message id="foilauth-edit_token-title">
        <source>Edit token</source>
        <extracomment>Dialog title</extracomment>
        <translation>Редактирование кода авторизации</translation>
    </message>
    ...
    <message id="foilauth-select_page-header">
        ...
        <translation>Выберите коды</translation>
    </message>
    ...
    <message id="foilauth-settings_page-front_camera-text">
        ...
        <oldsource>Use the front camera for scanning QR codes</oldsource>
    ...
    <message id="foilauth-settings_page-front_camera-description">
        ...
        <translation type="unfinished">Если не получается отсканировать QR-код основной камерой, то можно попробовать сделать это фронтальной камерой.</translation>
    </message>
