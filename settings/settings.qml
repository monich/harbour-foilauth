        ...
        Column {
            ...
            PageHeader {
                ...
                description: applicationName ?
                    ...
                    //% "Version %1"
                    qsTrId("foilauth-settings_page-header-version").arg("1.1.0") : ""
            ...
            TextSwitch {
                ...
                checked: autoLockSwitchValue.value
                onClicked: autoLockSwitchValue.value = !autoLockSwitchValue.value

                ConfigurationValue {
                    id: autoLockSwitchValue
